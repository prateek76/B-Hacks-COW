...
<body>
	...
	<div>
		<h3 id="navdars" style="text-align: center;float: right;margin-right: 40px;margin-bottom: 50px;border-bottom: 2px solid cornflowerblue;background: #00ffaf;padding: 5px;border-radius: 5px;">ALL REBATE's</h3>
		...
		<div id="myModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-header">
					<h4 class="modal-title">MESS REBATE</h4>
				</div>
...
<!--
	...
	-->
						...
						<div class="form-group">
						<label class="control-label col-sm-2" for="email">IFSC_CODE</label>
						<div class="col-sm-4">
						...
						<div class="form-group">
						<label class="control-label col-sm-2" for="email">BANK_NAME</label>
						<div class="col-sm-4">
						...
						<div class="form-group">
						<label class="control-label col-sm-2" for="email">BANK_HOLDER_NAME</label>
						<div class="col-sm-4">
						...
						<div class="form-group">
						<label class="control-label col-sm-2" for="email">HOSTEL</label>
						<div class="col-sm-4">
