...
?>
            ...
            <div class="row" style="padding-top: 30px">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="IFSC_CODE" name="IFSC_CODE">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone" placeholder="BANK_NAME" name="BANK_NAME">
                    </div>
                </div>
                <!--  col-md-6   -->
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>BANK_HOLDER_NAME</label>
                        <input type="text" class="form-control" placeholder="BANK_HOLDER_NAME" name="BANK_HOLDER_NAME">
                    </div>
