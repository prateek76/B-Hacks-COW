    ...
    if(!isset($_POST['submit'])){
        ...
        try {
            ...
            if($user != Null){
                ...
                $sql = $connection->prepare("INSERT INTO users (Name,Enroll,HOSTEL,Email,Password) VALUES (:name,:enroll,:HOSTEL,:email,:pass)");
                $cmd = $sql->execute(['name' => $Name , 'enroll' => $Enroll, 'HOSTEL' => $HOSTEL, 'email' => $Email,'pass' => $Pass]);
