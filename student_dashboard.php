...
<body>
	...
	<ul style="padding: 10px; margin-top: 70px">
		<button><li class="btn all_apps" >ALL REBATE's</li></button>
		<br>
		<div style="margin:8px 0;">

		<button><a href="form.php"\><li class="btn" >NEW REBATE</li></a></button>
		</div>
	...
	<div>
		<h3 id="navdars" style="text-align: center;float: right;margin-right: 40px;margin-bottom: 50px;border-bottom: 2px solid cornflowerblue;background: #00ffaf;padding: 5px;border-radius: 5px;">REBATE's</h3>
